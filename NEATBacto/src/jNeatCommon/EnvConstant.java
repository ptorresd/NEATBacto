...
public class EnvConstant {
	...
	public static int EDIT_CLASS_INP = 50;
	public static int EDIT_CLASS_OUT = 20;
	public static int EDIT_STATUS = 0;
	public static final int NR_UNIT_INPUT = 50;
	public static int NR_UNIT_MAX = 5;
	public static final int NR_UNIT_OUTPUT = 20;
